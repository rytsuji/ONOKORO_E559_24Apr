{
  ...
  TString file_root[n_file]={"run2078.hist.root","run2085.hist.root","run2125.hist.root","run2126.hist.root","run2189.hist.root"};
  ...
  gApplication->ProcessLine("gcom 40Ca(p,pt) Merged");  
}

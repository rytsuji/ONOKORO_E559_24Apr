{
  const int n_file=5; //number of input files
  //TString file_root[n_file]={"run2092.hist.root","run2096.hist.root","run2130.hist.root","run2131.hist.root","run2187.hist.root","run2188.hist.root"};
  TString file_root[n_file]={"run2092.hist.root","run2096.hist.root","run2130.hist.root","run2131.hist.root","run2188.hist.root"};
  ...
  gApplication->ProcessLine("gcom 42Ca(p,p3He) Merged");

//void ppt_40Ca(double scale=1.0){
{
  ...
  t1.SetTextAlign(12);
  t1.SetTextAngle(90);
  t1.DrawLatex(Sh+E1,y1+0.05/5,Form("#scale[%f]{1.37 MeV}",scale*0.75));
  ...
  f_40Ca->SetParameters(0.05,Sh,
			...
			0.1,Sh+E2,
			0.4);
  f_40Ca->FixParameter(0,0.0);
  f_40Ca->FixParameter(1,Sh);
  sx->Fit("f_40Ca","E","",19.5,22.0);
  ...
  title.SetNDC(1);
  title.DrawLatex(.55,.8,Form("#scale[%f]{^{40}Ca(#it{p,p}^{3}He)^{37}Ar}",1.0*scale));

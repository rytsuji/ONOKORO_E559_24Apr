{
  ...
  double scale_mylar=(0.21808865/(11.8/39.962))*0.0943;  
  ...
  TFile *file_mylar_t  = TFile::Open("output/calib_pid/hist_ex/ppt_mylar_40Ca.root ");
  TFile *file_carbon_t = TFile::Open("output/calib_pid/hist_ex/ppt_carbon_40Ca.root ");
  TFile *file_Ca_t     = TFile::Open("output/calib_pid/hist_ex/ppt_40Ca_40Ca.root ");

  TFile *file_mylar_h  = TFile::Open("output/calib_pid/hist_ex/pph_mylar_40Ca.root ");
  TFile *file_carbon_h = TFile::Open("output/calib_pid/hist_ex/pph_carbon_40Ca.root ");
  TFile *file_Ca_h     = TFile::Open("output/calib_pid/hist_ex/pph_40Ca_40Ca.root ");

{
  ...
  double scale_mylar=(0.21808865/(9.7/43.955))*0.284;
  ...
  TFile *file_mylar_t  = TFile::Open("output/calib_pid/hist_ex/ppt_mylar_44Ca.root ");
  TFile *file_carbon_t = TFile::Open("output/calib_pid/hist_ex/ppt_carbon_44Ca.root ");
  TFile *file_Ca_t     = TFile::Open("output/calib_pid/hist_ex/ppt_44Ca_44Ca.root ");

  TFile *file_mylar_h  = TFile::Open("output/calib_pid/hist_ex/pph_mylar_44Ca.root ");
  TFile *file_carbon_h = TFile::Open("output/calib_pid/hist_ex/pph_carbon_44Ca.root ");
  TFile *file_Ca_h     = TFile::Open("output/calib_pid/hist_ex/pph_44Ca_44Ca.root ");

{
  Int_t rebin=20; //1 MeV

  double scale_mylar=(0.21808865/(10.0/41.958))*0.449;
  ...
  TFile *file_mylar_t  = TFile::Open("output/calib_pid/hist_ex/ppt_mylar_42Ca.root ");
  TFile *file_carbon_t = TFile::Open("output/calib_pid/hist_ex/ppt_carbon_42Ca.root ");
  TFile *file_Ca_t     = TFile::Open("output/calib_pid/hist_ex/ppt_42Ca_42Ca.root ");

  TFile *file_mylar_h  = TFile::Open("output/calib_pid/hist_ex/pph_mylar_42Ca.root ");
  TFile *file_carbon_h = TFile::Open("output/calib_pid/hist_ex/pph_carbon_42Ca.root ");
  TFile *file_Ca_h     = TFile::Open("output/calib_pid/hist_ex/pph_42Ca_42Ca.root ");

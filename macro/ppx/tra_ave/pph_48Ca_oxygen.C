{
  ...
  TFile *file_mylar = TFile::Open("macro/ppx/output_sx/pph_48Ca_mylar.root");
  TFile *file_carbon = TFile::Open("macro/ppx/output_sx/pph_48Ca_carbon.root");
  ...
  TFile *fout = new TFile("macro/ppx/output_sx/pph_48Ca_16O_tave.root","RECREATE");
  sx_mylar->Write();
  sx_carbon->Write();
  sx_oxygen->Write();
  sx_mylar0->Write();

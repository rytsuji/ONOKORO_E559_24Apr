
{
  ...
  //
  TFile *file_16O = TFile::Open("macro/ppx/output_sx/pph_48Ca_16O_tave.root");
  ...
  */
  ...
  title.SetNDC(1);
  title.DrawLatex(.65,offset+0.8*(1-offset),Form("#scale[%e]{^{16}O(#it{p,p}^{3}He)}",1.5*(1.0-offset)));
  title.DrawLatex(.65,offset+0.7*(1-offset),Form("#scale[%e]{#it{S}_{^{3}He}=22.793 MeV}",1.2*(1.0-offset)));

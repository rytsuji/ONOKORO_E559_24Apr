{
  //
  TFile *file_40Ca = TFile::Open("macro/ppx/output_sx/pph_40Ca_tave.root");
  ...
  t0.SetTextAlign(12);
  t0.SetTextAngle(90);
  t0.DrawLatex(Sh,y0+0.06,"#scale[1.2]{gnd (3/2^{+})}");
  ...
  t1.SetTextAlign(12);
  t1.SetTextAngle(90);
  t1.DrawLatex(Sh+E1-0.4,y1+0.06,"#scale[1.2]{1.40 MeV}");
  t1.DrawLatex(Sh+E1+0.4,y1+0.06,"#scale[1.2]{(1/2^{+})}");
  ...
  title.SetNDC(1);
  title.DrawLatex(.65,.8,"#scale[1.5]{^{40}Ca(#it{p,p}^{3}He)}");
  title.DrawLatex(.65,.7,"#scale[1.2]{#it{S}_{^{3}He}=18.830 MeV}");

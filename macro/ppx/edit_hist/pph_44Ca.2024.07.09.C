{
  ...
  */
  ...
  Double_t y1=0.05;
  dE1=-0.2;
  TArrow a1(Sh+E1+dE1,y1,Sh+E1+dE1,y1+0.05,0.01,"<|");
  a1.Draw();
  TLatex t1;
  t1.SetTextAlign(12);
  t1.SetTextAngle(90);
  t1.DrawLatex(Sh+E1+dE1,y1+0.06,"#scale[1.2]{3/2^{+}?}");
  ...
  t2.SetTextAlign(12);
  t2.SetTextAngle(90);
  t2.DrawLatex(Sh+E2+0.25,y2+0.07,"#scale[1.2]{1.86 MeV (1/2^{+})}");
  ...
  title.SetNDC(1);
  title.DrawLatex(.65,.8,"#scale[1.5]{^{44}Ca(#it{p,p}^{3}He)}");
  title.DrawLatex(.65,.7,"#scale[1.2]{#it{S}_{^{3}He}=23.3322 MeV}");

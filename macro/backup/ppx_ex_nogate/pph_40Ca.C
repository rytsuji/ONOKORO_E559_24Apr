{
  ...
  double scale=1;
  TFile *file_mylar = TFile::Open("output/ppx_ex_nogate/pph_mylar_40Ca.root ");  
  TFile *file_carbon = TFile::Open("output/ppx_ex_nogate/pph_carbon_40Ca.root ");
  TFile *file_40Ca = TFile::Open("output/ppx_ex_nogate/pph_40Ca_40Ca.root ");  
  ...
  TFile *fout = new TFile("output/ppx_ex_nogate/pph_40Ca.root","RECREATE");
  h_40Ca->Write();
  h_40Ca0->Write();
  sx->Write();
  sx0->Write();

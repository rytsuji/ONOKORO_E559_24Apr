{
  ...
  double scale=1;
  TFile *file_mylar = TFile::Open("output/ppx_ex_nogate/ppt_mylar_48Ca.root ");  
  TFile *file_carbon = TFile::Open("output/ppx_ex_nogate/ppt_carbon_48Ca.root ");
  TFile *file_48Ca = TFile::Open("output/ppx_ex_nogate/ppt_48Ca_48Ca.root ");  
  ...
  TFile *fout = new TFile("output/ppx_ex_nogate/ppt_48Ca.root","RECREATE");                                                                                       
  h_48Ca->Write();
  h_48Ca0->Write();

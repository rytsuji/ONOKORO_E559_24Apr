{
  ...
  double scale=1;
  TFile *file_mylar = TFile::Open("output/ppx_ex/pph_48Ca_mylar_48Ca.root ");  
  TFile *file_carbon = TFile::Open("output/ppx_ex/pph_48Ca_carbon_48Ca.root ");
  TFile *file_48Ca = TFile::Open("output/ppx_ex/pph_48Ca_48Ca_48Ca.root ");  
  ...
  TFile *fout = new TFile("output/ppx_ex/pph_48Ca.root","RECREATE");
  h_48Ca->Write();
  h_48Ca0->Write();
  h_48Ca_raw->Write();
  h_48Ca0_raw->Write();

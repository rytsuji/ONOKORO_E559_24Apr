{
  ...
  double scale=1;
  TFile *file_mylar = TFile::Open("output/ppx_ex/pph_mylar_44Ca.root ");  
  TFile *file_carbon = TFile::Open("output/ppx_ex/pph_carbon_44Ca.root ");
  TFile *file_44Ca = TFile::Open("output/ppx_ex/pph_44Ca_44Ca.root ");  
  ...
  TFile *fout = new TFile("output/ppx_ex/pph_44Ca.root","RECREATE");
  h_44Ca->Write();
  h_44Ca0->Write();
  h_44Ca_raw->Write();
  h_44Ca0_raw->Write();

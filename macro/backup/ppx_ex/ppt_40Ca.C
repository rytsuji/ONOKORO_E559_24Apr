{
  ...
  double scale=1;
  TFile *file_mylar = TFile::Open("output/ppx_ex/ppt_mylar_40Ca.root ");  
  TFile *file_carbon = TFile::Open("output/ppx_ex/ppt_carbon_40Ca.root ");
  TFile *file_40Ca = TFile::Open("output/ppx_ex/ppt_40Ca_40Ca.root ");  
  ...
  TFile *fout = new TFile("output/ppx_ex/ppt_40Ca.root","RECREATE");                                                                                       
  h_40Ca->Write();
  h_40Ca0->Write();

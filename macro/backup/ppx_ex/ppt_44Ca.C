{
  ...
  double scale=1;
  TFile *file_mylar = TFile::Open("output/ppx_ex/ppt_mylar_44Ca.root ");  
  TFile *file_carbon = TFile::Open("output/ppx_ex/ppt_carbon_44Ca.root ");
  TFile *file_44Ca = TFile::Open("output/ppx_ex/ppt_44Ca_44Ca.root ");  
  ...
  TFile *fout = new TFile("output/ppx_ex/ppt_44Ca.root","RECREATE");                                                                                       
  h_44Ca->Write();
  h_44Ca0->Write();

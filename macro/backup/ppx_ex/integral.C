...
void integral(void){
  ...
  //ppt
  TFile *file_40Ca_ppt = TFile::Open("output/ppx_ex/ppt_40Ca.weight.root ");
  TFile *file_42Ca_ppt = TFile::Open("output/ppx_ex/ppt_42Ca.weight.root ");
  TFile *file_44Ca_ppt = TFile::Open("output/ppx_ex/ppt_44Ca.weight.root ");
  TFile *file_48Ca_ppt = TFile::Open("output/ppx_ex/ppt_48Ca.weight.root ");
  ...
  //ppt
  TFile *file_40Ca_pph = TFile::Open("output/ppx_ex/pph_40Ca.weight.root ");
  TFile *file_42Ca_pph = TFile::Open("output/ppx_ex/pph_42Ca.weight.root ");
  TFile *file_44Ca_pph = TFile::Open("output/ppx_ex/pph_44Ca.weight.root ");
  TFile *file_48Ca_pph = TFile::Open("output/ppx_ex/pph_48Ca.weight.root ");

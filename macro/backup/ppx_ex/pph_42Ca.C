{
  ...
  double scale=1;
  TFile *file_mylar = TFile::Open("output/ppx_ex/pph_mylar_42Ca.root ");  
  TFile *file_carbon = TFile::Open("output/ppx_ex/pph_carbon_42Ca.root ");
  TFile *file_42Ca = TFile::Open("output/ppx_ex/pph_42Ca_42Ca.root ");  
  ...
  TFile *fout = new TFile("output/ppx_ex/pph_42Ca.root","RECREATE");
  h_42Ca->Write();
  h_42Ca0->Write();
  sx->Write();
  sx0->Write();

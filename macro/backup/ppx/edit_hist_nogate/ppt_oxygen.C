{
  ...
  h_oxygen->SetLabelSize(0.075*scale,"xy");
  //h_oxygen->GetXaxis()->SetRange(h_oxygen->FindBin(10),h_oxygen->FindBin(45));
  ...
  Double_t y1_16O=0.05;
  TArrow a1_16O(St_16O+E1_16O,y1_16O,St_16O+E1_16O,y1_16O+0.05/2,0.01,"<|");
  a1_16O.Draw();
  t_16O.DrawLatex(St_16O+E1_16O,y1_16O+0.06/2,Form("#scale[%f]{2.36 MeV (1/2^{+})}",0.75*scale));
  ...
  t_16O.DrawLatex(St_16O+E2_16O+2.0+0.35,y2_16O+0.11/2,Form("#scale[%f]{and 3.54 MeV (5/2^{+})}",0.75*scale));

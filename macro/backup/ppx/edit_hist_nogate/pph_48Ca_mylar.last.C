{
  ...
  double scale=1/1.1;
  TFile *file_mylar = TFile::Open("output/ppx/pph_48Ca_mylar.tra_ave.root ");  
  TFile *file_carbon = TFile::Open("output/ppx/pph_48Ca_carbon.tra_ave.root ");
  ...
  Double_t E2_16O=7.686;
  Double_t y2_16O=0.10;
  TArrow a2_16O(St_16O+E2_16O,y2_16O,St_16O+E2_16O,y2_16O+0.05/2,0.01,"<|");
  a2_16O.Draw();
  t_16O.DrawLatex(St_16O+E2_16O+0.5,y2_16O+0.06/2,Form("#scale[%f]{7.68 MeV (3/2^{+})}",0.75));

  Double_t E3_16O=8.20;
  Double_t y3_16O=0.05;
  TArrow a3_16O(St_16O+E3_16O,y3_16O,St_16O+E3_16O,y3_16O+0.05/2,0.01,"<|");
  TArrow a3_16O_1(St_16O+E3_16O,y3_16O+0.05/2,St_16O+E3_16O+1.0,y3_16O+0.1/2,0.01,"");
  a3_16O.Draw();
  a3_16O_1.Draw();  
  t_16O.DrawLatex(St_16O+E3_16O+1.0,y3_16O+0.11/2,Form("#scale[%f]{8.20 MeV (3/2^{+})}",0.75));
  ...
  title.DrawLatex(.65,.7,Form("#scale[%f]{^{48}O(#it{p,p}^{3}He) setup}",1.0*scale));  

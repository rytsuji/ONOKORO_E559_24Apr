{
  ...
  //f_40Ca->SetParLimits(6,0.0,1.0);  
  //f_40Ca->SetParLimits(8,0.0,1.0);
  //f_40Ca->SetParLimits(10,0.0,1.0);  
  /*
  ...
  */
  ...
  f_40Ca->SetParameter(12,0.4);
  //f_40Ca->SetParameter(8,0.4);  
  
  f_40Ca->SetParameter(0,0.01);
  f_40Ca->SetParameter(2,0.1);
  f_40Ca->SetParameter(4,0.01);
  f_40Ca->SetParameter(6,0.01);  
  f_40Ca->SetParameter(8,0.01);
  f_40Ca->SetParameter(10,0.01);

  
  f_40Ca->SetParameter(1,Sh);
  f_40Ca->SetParameter(3,Sh+E1);
  //f_40Ca->SetParameter(5,Sh+E4);
  //f_40Ca->SetParameter(7,Sh+E5);

  //f_40Ca->FixParameter(5,Sh+E2);
  //f_40Ca->FixParameter(7,Sh+E3);
  //f_40Ca->FixParameter(9,Sh+E4);
  //f_40Ca->FixParameter(11,Sh+E5);
  double dE=0.1;
  f_40Ca->SetParLimits(5, Sh+E2-dE,Sh+E2+dE);
  f_40Ca->SetParLimits(7, Sh+E3-dE,Sh+E3+dE);
  f_40Ca->SetParLimits(9, Sh+E4-dE,Sh+E4+dE);
  f_40Ca->SetParLimits(11,Sh+E5-dE,Sh+E5+dE);

  f_40Ca->SetParLimits(0,0,1);
  f_40Ca->SetParLimits(2,0,1);
  f_40Ca->SetParLimits(4,0,1);
  f_40Ca->SetParLimits(6,0,1);
  f_40Ca->SetParLimits(8,0,1);
  f_40Ca->SetParLimits(10,0,1);    

  //f_40Ca->FixParameter(5, Sh+E2);
  //f_40Ca->FixParameter(7, Sh+E3);
  //f_40Ca->FixParameter(4, 0);
  ...
  title.DrawLatex(.65,.65,Form("#scale[%f]{TDX = %8.3f #pm %8.3f}",scale*0.8,tdx,tdx_err));

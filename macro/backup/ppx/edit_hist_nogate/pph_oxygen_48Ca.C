{
  ...
  double scale=1;
  TFile *file_mylar = TFile::Open("output/ppx_nogate/pph_48Ca_mylar.tra_ave.root ");  
  TFile *file_carbon = TFile::Open("output/ppx_nogate/pph_48Ca_carbon.tra_ave.root ");
  TFile *file_48Ca = TFile::Open("output/ppx_nogate/pph_48Ca_48Ca.tra_ave.root ");  
  ...
  Double_t scale_carbon=0.66348429*(48.0080/10.47)/(12.0/10.65);//*(1.2579198);
  ...
  */  
  ...
  title.DrawLatex(.65,.8,Form("#scale[%f]{^{48}Ca(#it{p,pt}}^{3}He)",1.0*scale));

...
void ppt(void){
  ...
  TFile *file_mylar = TFile::Open("output/ppx/ppt_mylar.root");
  TFile *file_carbon = TFile::Open("output/ppx/ppt_carbon.root");

  Double_t scale=0.66348429*(48.0080/10.47)/(12.0/10.65);
  TFile *fout = new TFile("macro/ppx/output_sx/ppt_oxygen.root","RECREATE");
  ...
  TFile *file = new TFile("macro/ppx/output_sx/ppt_oxygen.root"); 

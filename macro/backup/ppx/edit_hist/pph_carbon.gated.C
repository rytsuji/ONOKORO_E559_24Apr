{
  ...
  TFile *file_carbon = TFile::Open("output/ppx/pph_carbon.gated.tra_ave.root ");  

  Double_t ymin=-0.0499;
  Double_t ymax=1.1999;
  ...
  title.SetNDC(1);
  title.DrawLatex(.65,.8,"#scale[1.0]{^{12}C(#it{p,p}^{3}He)}");
  title.DrawLatex(.65,.725,"#scale[0.8]{#it{S_{t}}=26.280 MeV}");

{
  ...
  TFile *file_40Ca = TFile::Open("output/ppx/pph_40Ca.gated.tra_ave.root");
  ...
  t0.SetTextAlign(12);
  t0.SetTextAngle(90);
  t0.DrawLatex(Sh,y0+0.06,"#scale[0.75]{gnd (3/2^{+})}");
  ...
  t1.SetTextAlign(12);
  t1.SetTextAngle(90);
  t1.DrawLatex(Sh+E1-1.0,y1+0.06,"#scale[0.75]{1.40 MeV}");
  t1.DrawLatex(Sh+E1+0.5,y1+0.06,"#scale[0.75]{(1/2^{+})}");
  ...
  */
  ...
  f_40Ca->SetParameters(0.05,19.3,
			1.0,Sh+E1+0.26570000,
			0.01,Sh+E2+0.26570000,
			0.01,Sh+E3+0.26570000,
			0.01,Sh+E4+0.26570000,		   			
			0.5);
  //f_40Ca->FixParameter(1,Sh+0.26570000);
  //f_40Ca->FixParameter(1,Sh+E2+0.26570000);  
  f_40Ca->FixParameter(5,Sh+E2+0.26570000);
  f_40Ca->FixParameter(7,Sh+E3+0.26570000);
  f_40Ca->FixParameter(9,Sh+E4+0.26570000);
  ...
  title.SetNDC(1);
  title.DrawLatex(.65,.8,"#scale[1.0]{^{40}Ca(#it{p,p}^{3}He)}");
  title.DrawLatex(.65,.725,"#scale[0.8]{#it{S}_{^{3}He}=18.830 MeV}");

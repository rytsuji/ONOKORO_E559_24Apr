void tra_ave_lowres(TString infile){
  ...
  Double_t c[5]={TMath::Gaus(-2*dx,0,1.0),
		 TMath::Gaus(-dx,0,1.0),
		 TMath::Gaus(0,0,1.0),
		 TMath::Gaus(dx,0,1.0),
		 TMath::Gaus(2*dx,0,1.0)};
  
  /*
  Double_t c[5]={TMath::Gaus(-4*dx,0,1.0),
		 TMath::Gaus(-3*dx,0,1.0),
		 TMath::Gaus(-2*dx,0,1.0),
		 TMath::Gaus(-dx,0,1.0),
		 TMath::Gaus(0,0,1.0),
		 TMath::Gaus(dx,0,1.0),

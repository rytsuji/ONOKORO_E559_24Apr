{
  ...
  TFile *file_mylar_ppt = TFile::Open("output/ppx_nogate/ppt_mylar.weight.root ");  
  TFile *file_carbon_ppt = TFile::Open("output/ppx_nogate/ppt_carbon.weight.root ");
  TFile *file_40Ca_ppt = TFile::Open("output/ppx_nogate/ppt_40Ca.weight.root ");
  TFile *file_42Ca_ppt = TFile::Open("output/ppx_nogate/ppt_42Ca.weight.root ");
  TFile *file_44Ca_ppt = TFile::Open("output/ppx_nogate/ppt_44Ca.weight.root ");
  TFile *file_48Ca_ppt = TFile::Open("output/ppx_nogate/ppt_48Ca.weight.root ");
  ...
  Double_t integral_mylar_ppt=h_mylar_ppt->Integral(h_mylar_ppt->FindBin(18.0),h_mylar_ppt->FindBin(32.0));
  Double_t integral_carbon_ppt=h_carbon_ppt->Integral(h_carbon_ppt->FindBin(18.0),h_carbon_ppt->FindBin(32.0));
  Double_t integral_40Ca_ppt=h_40Ca_ppt->Integral(h_40Ca_ppt->FindBin(18.0),h_40Ca_ppt->FindBin(32.0));
  Double_t integral_42Ca_ppt=h_42Ca_ppt->Integral(h_42Ca_ppt->FindBin(18.0),h_42Ca_ppt->FindBin(32.0));
  Double_t integral_44Ca_ppt=h_44Ca_ppt->Integral(h_44Ca_ppt->FindBin(18.0),h_44Ca_ppt->FindBin(32.0));
  Double_t integral_48Ca_ppt=h_48Ca_ppt->Integral(h_48Ca_ppt->FindBin(18.0),h_48Ca_ppt->FindBin(32.0));
  ...
  //pph
  TFile *file_mylar_pph = TFile::Open("output/ppx_nogate/pph_mylar.weight.root ");  
  TFile *file_carbon_pph = TFile::Open("output/ppx_nogate/pph_carbon.weight.root ");
  TFile *file_40Ca_pph = TFile::Open("output/ppx_nogate/pph_40Ca.weight.root ");
  TFile *file_42Ca_pph = TFile::Open("output/ppx_nogate/pph_42Ca.weight.root ");
  TFile *file_44Ca_pph = TFile::Open("output/ppx_nogate/pph_44Ca.weight.root ");

  TFile *file_48Ca_mylar_pph = TFile::Open("output/ppx_nogate/pph_48Ca_mylar.weight.root ");
  TFile *file_48Ca_carbon_pph = TFile::Open("output/ppx_nogate/pph_48Ca_carbon.weight.root ");
  TFile *file_48Ca_pph = TFile::Open("output/ppx_nogate/pph_48Ca_48Ca.weight.root ");
  ...
  Double_t integral_mylar_pph=h_mylar_pph->Integral(h_mylar_pph->FindBin(15.0),h_mylar_pph->FindBin(32.0));
  Double_t integral_carbon_pph=h_carbon_pph->Integral(h_carbon_pph->FindBin(15.0),h_carbon_pph->FindBin(32.0));
  Double_t integral_40Ca_pph=h_40Ca_pph->Integral(h_40Ca_pph->FindBin(15.0),h_40Ca_pph->FindBin(32.0));
  Double_t integral_42Ca_pph=h_42Ca_pph->Integral(h_42Ca_pph->FindBin(15.0),h_42Ca_pph->FindBin(32.0));
  Double_t integral_44Ca_pph=h_44Ca_pph->Integral(h_44Ca_pph->FindBin(15.0),h_44Ca_pph->FindBin(32.0));

  Double_t integral_48Ca_mylar_pph=h_48Ca_mylar_pph->Integral(h_48Ca_mylar_pph->FindBin(28.0),h_48Ca_mylar_pph->FindBin(40.0));
  Double_t integral_48Ca_carbon_pph=h_48Ca_carbon_pph->Integral(h_48Ca_carbon_pph->FindBin(28.0),h_48Ca_carbon_pph->FindBin(40.0));
  Double_t integral_48Ca_pph=h_48Ca_pph->Integral(h_48Ca_pph->FindBin(28.0),h_48Ca_pph->FindBin(40.0));

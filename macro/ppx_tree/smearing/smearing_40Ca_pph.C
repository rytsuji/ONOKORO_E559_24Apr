void smearing_40Ca_pph(void){
  TString infile="output/calib_pid/hist_ex/pph_40Ca.root";
  TFile *file0 = TFile::Open(infile);

  
  TH1F* sx = (TH1F*)file0->Get("h_40Ca")->Clone("sx");
  ...
  Double_t c[5]={ TMath::Gaus(-2*dx,0,sigma),

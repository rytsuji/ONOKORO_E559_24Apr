{
  ...
  TFile *file0 = TFile::Open("output/calib_pid/hist_ex/pph_40Ca.nogate.root");   
  ...
  TFile *file1 = TFile::Open("output/calib_pid/hist_ex/ppt_40Ca.nogate.root"); 
  ...
  //42Ca
  TFile *file2 = TFile::Open("output/calib_pid/hist_ex/pph_42Ca.nogate.root");   
  c1->cd(2);
  h_42Ca->Rebin(bin);
  h_42Ca0->Rebin(bin);
  ...
  TFile *file3 = TFile::Open("output/calib_pid/hist_ex/ppt_42Ca.nogate.root"); 
  ...
  lz->Draw("same");
  //44Ca
  TFile *file4 = TFile::Open("output/calib_pid/hist_ex/ppt_44Ca.nogate.root");   
  c1->cd(3);
  ...
  TFile *file5 = TFile::Open("output/calib_pid/hist_ex/pph_44Ca.nogate.root"); 
  h_44Ca->Rebin(bin);
  h_44Ca0->Rebin(bin);
  h_44Ca->Draw("same E1");
  h_44Ca0->Draw("same");
  ...
  //48Ca
  TFile *file6 = TFile::Open("output/calib_pid/hist_ex/ppt_48Ca.nogate.root");   
  c1->cd(4);
  ...
  TFile *file7 = TFile::Open("output/calib_pid/hist_ex/pph_48Ca.nogate.root"); 
  h_48Ca->Rebin(bin);
  h_48Ca0->Rebin(bin);
  h_48Ca->Draw("same E1");
  h_48Ca0->Draw("same");

{
  ...
  TFile *file0 = TFile::Open("output/calib_pid/hist_ex/ppt_oxygen.nogate.root");   
  ...
  //(p,ph)
  TFile *file1 = TFile::Open("output/calib_pid/hist_ex/pph_oxygen.nogate.root");
  c1->cd(2);
  h_mylar->Rebin(bin);
  h_mylar0->Rebin(bin);
  h_mylar->SetMinimum(ymin);
  ...
  //(p,ph) 48Ca setup
  TFile *file2 = TFile::Open("output/calib_pid/hist_ex/pph_48Ca_oxygen.nogate.root");
  c1->cd(3);
  h_mylar->Rebin(bin);
  h_mylar0->Rebin(bin);
  h_mylar->SetMinimum(ymin);

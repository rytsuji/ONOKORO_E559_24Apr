{
  ...
  double scale=1;
  TFile *file_mylar = TFile::Open("output/calib_pid/hist_ex/pph_mylar_40Ca.nogate.root ");
  TFile *file_carbon = TFile::Open("output/calib_pid/hist_ex/pph_carbon_40Ca.nogate.root ");
  TFile *file_40Ca = TFile::Open("output/calib_pid/hist_ex/pph_40Ca_40Ca.nogate.root ");
  ...
  TFile *fout = new TFile("output/calib_pid/hist_ex/pph_40Ca.nogate.root","RECREATE");
  h_oxygen->Write();
  h_oxygen0->Write();
  h_40Ca_raw->Write();
  h_40Ca0_raw->Write();

{
  ...
  double scale=1;
  TFile *file_mylar = TFile::Open("output/calib_pid/hist_ex/ppt_mylar_44Ca.nogate.root ");
  TFile *file_carbon = TFile::Open("output/calib_pid/hist_ex/ppt_carbon_44Ca.nogate.root ");
  TFile *file_44Ca = TFile::Open("output/calib_pid/hist_ex/ppt_44Ca_44Ca.nogate.root ");
  ...
  TFile *fout = new TFile("output/calib_pid/hist_ex/ppt_44Ca.nogate.root","RECREATE");
  h_oxygen->Write();
  h_oxygen0->Write();
  h_44Ca_raw->Write();
  h_44Ca0_raw->Write();

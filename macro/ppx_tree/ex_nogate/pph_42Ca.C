{
  ...
  double scale=1;
  TFile *file_mylar = TFile::Open("output/calib_pid/hist_ex/pph_mylar_42Ca.nogate.root ");
  TFile *file_carbon = TFile::Open("output/calib_pid/hist_ex/pph_carbon_42Ca.nogate.root ");
  TFile *file_42Ca = TFile::Open("output/calib_pid/hist_ex/pph_42Ca_42Ca.nogate.root ");
  ...
  TFile *fout = new TFile("output/calib_pid/hist_ex/pph_42Ca.nogate.root","RECREATE");
  h_oxygen->Write();
  h_oxygen0->Write();
  h_42Ca_raw->Write();
  h_42Ca0_raw->Write();

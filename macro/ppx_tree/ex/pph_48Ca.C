{
  ...
  double scale=1;
  TFile *file_mylar = TFile::Open("output/calib_pid/hist_ex/pph_48Ca_mylar_48Ca.root ");
  TFile *file_carbon = TFile::Open("output/calib_pid/hist_ex/pph_48Ca_carbon_48Ca.root ");
  TFile *file_48Ca = TFile::Open("output/calib_pid/hist_ex/pph_48Ca_48Ca_48Ca.root ");
  ...
  TFile *fout = new TFile("output/calib_pid/hist_ex/pph_48Ca.root","RECREATE");
  h_oxygen->Write();
  h_oxygen0->Write();
  h_48Ca_raw->Write();
  h_48Ca0_raw->Write();

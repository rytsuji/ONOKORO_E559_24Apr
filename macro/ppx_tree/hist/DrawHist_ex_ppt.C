{
  ...
  TFile *file0 = TFile::Open("output/calib_pid/hist_ex/ppt_40Ca.root");   
  ...
  //42Ca
  TFile *file1 = TFile::Open("output/calib_pid/hist_ex/ppt_42Ca.root");   
  c1->cd(2);
  ...
  //44Ca
  TFile *file2 = TFile::Open("output/calib_pid/hist_ex/ppt_44Ca.root");   
  c1->cd(3);
  ...
  //48Ca
  TFile *file3 = TFile::Open("output/calib_pid/hist_ex/ppt_48Ca.root");   
  c1->cd(4);

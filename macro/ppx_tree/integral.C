...
void integral(void){
  ...
  double ppt_range[2]={-0.2*3.0,10.0};
  double pph_range[2]={-0.37*3.0,10.0};
  double pph_48Ca_range[2]={-0.37*3.0,10.0};  

  //ppt
  TFile *file_40Ca_ppt = TFile::Open("output/calib_pid/hist_ex/ppt_40Ca.root ");
  TFile *file_42Ca_ppt = TFile::Open("output/calib_pid/hist_ex/ppt_42Ca.root ");
  TFile *file_44Ca_ppt = TFile::Open("output/calib_pid/hist_ex/ppt_44Ca.root ");
  TFile *file_48Ca_ppt = TFile::Open("output/calib_pid/hist_ex/ppt_48Ca.root ");
  ...
  //ppt
  TFile *file_40Ca_pph = TFile::Open("output/calib_pid/hist_ex/pph_40Ca.root ");
  TFile *file_42Ca_pph = TFile::Open("output/calib_pid/hist_ex/pph_42Ca.root ");
  TFile *file_44Ca_pph = TFile::Open("output/calib_pid/hist_ex/pph_44Ca.root ");
  TFile *file_48Ca_pph = TFile::Open("output/calib_pid/hist_ex/pph_48Ca.root ");

{
  ...
  */
  ...
  t1.SetTextAlign(12);
  t1.SetTextAngle(90);
  t1.DrawLatex(Sh+E1-0.5,y1+0.11/5,Form("#scale[%f]{1.03 MeV (3/2^{+})}",0.75*scale));
  ...
  t2.SetTextAlign(12);
  t2.SetTextAngle(90);
  t2.DrawLatex(Sh+E2-0.5,y2+0.11/5,Form("#scale[%f]{1.86 MeV (1/2^{+})}",0.75*scale));
  ...
  f_44Ca->SetParLimits(3,Sh+E1-0.2,Sh+E1+0.2);
  ...
  f_44Ca->SetParameters(0.1/10,22.5,
			0.05/10,24.51,
			0.3/10,25,
			0.5/10,26.5,
			0.4);
  ...
  f_44Ca_peak->SetParameters(f_44Ca->GetParameter(4),
                             f_44Ca->GetParameter(5),
                             f_44Ca->GetParameter(8));

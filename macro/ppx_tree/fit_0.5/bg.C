{
  ...
  TPad *pad2 = new TPad("pad2", "pad2",
			lmargin,1.00-tmargin-dy*3.0-dy*0.1, 
			1.00,1.00-tmargin-dy*2.0);						

  pad2->SetTopMargin(0.0);
  pad2->SetBottomMargin(xlabelmargin);
  pad2->Draw();
  ...
  pad1->cd();
  gApplication->ProcessLine(".x macro/ppx/edit_hist/pph_mylar.C");
  gApplication->ProcessLine(".x macro/ppx/edit_hist/pph_mylar.C");



  pad2->cd();
  gApplication->ProcessLine(".x macro/ppx/edit_hist/pph_48Ca_mylar.last.C");
  gApplication->ProcessLine(".x macro/ppx/edit_hist/pph_48Ca_mylar.last.C");
 
  c1->SaveAs("figs/sx_fit/bg.pdf");
  c1->SaveAs("figs/sx_fit/bg.png");

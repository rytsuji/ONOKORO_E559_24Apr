{
  ...
  TFile *file_40Ca = TFile::Open("output/ppx/ppt_40Ca.gated.tra_ave.root ");  

  Double_t ymin=-0.0499;
  Double_t ymax=0.7499;
  ...
  t1.SetTextAlign(12);
  t1.SetTextAngle(90);
  t1.DrawLatex(St+E1-1.0,y1+0.05,"#scale[0.75]{1.37 MeV}");
  t1.DrawLatex(St+E1+1.0,y1+0.05,"#scale[0.75]{  (1/2^{+})}");
  /*
  Double_t y2=0.06;
  ...
  */
  ...
  title.SetNDC(1);
  title.DrawLatex(.65,.8,"#scale[1.0]{^{40}Ca#it{(p,pt)}}");
  title.DrawLatex(.65,.725,"#scale[0.8]{#it{S_{t}}=24.996 MeV}");

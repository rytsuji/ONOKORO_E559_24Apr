{
  ...
  */
  ...
  double tdx_err=f_44Ca->GetParError(0)/((double) 50.0/Nbin);
  ...
  f_44Ca_peak->SetLineColor(1);
  f_44Ca_peak->SetLineWidth(1);
  f_44Ca_peak->SetLineStyle(2);    
  f_44Ca_peak->SetFillColor(1);
  f_44Ca_peak->SetFillStyle(3001);

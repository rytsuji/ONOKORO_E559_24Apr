{
  ...
  //TFile *_file0 = TFile::Open("output/las/run5451129_4.root");
  TFile *_file0 = TFile::Open("output/sieve/run5451129_4.root");    
  ofstream ofile("work/ang_las_ppt/dat/fit4.dat");
  ...
  TCut bcut = "abs(lfp.fB-lfp.GetY(-495.788)/2.484711e+03)<0.025";
  
  //A Y cut
  Double_t arange[6]={-0.2,-0.07,-0.0,0.062,0.13,0.2};
  Double_t yrange[6]={-90,-48,-2,20,65,105};

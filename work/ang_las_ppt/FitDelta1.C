{
  ...
  //TFile *_file0 = TFile::Open("output/las/run5451129_1.root");
  TFile *_file0 = TFile::Open("output/sieve/run5451129_1.root");  
  ...
  //A Y cut
  Double_t arange[6]={-0.3,-0.185,-0.105,-0.02,0.055,0.16};
  ...
  //Fit
  ofstream ofile("work/ang_las_ppt/dat/fit1.dat");

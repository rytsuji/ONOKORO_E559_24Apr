{
  //TFile *_file0 = TFile::Open("output/las/run5451129_5.root");
  TFile *_file0 = TFile::Open("output/sieve/run5451129_5.root");  
  ofstream ofile("work/ang_las_ppt/dat/fit5.dat");
  ...
  //A Y cut
  Double_t arange[6]={-0.12,-0.04,0.02,0.08,0.15,0.2};
  Double_t yrange[6]={-85,-30,3,16,47,94};

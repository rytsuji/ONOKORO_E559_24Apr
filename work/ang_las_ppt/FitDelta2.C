{
  ...
  //TFile *_file0 = TFile::Open("output/las/run5451129_2.root");
  TFile *_file0 = TFile::Open("output/sieve/run5451129_2.root");  
  ofstream ofile("work/ang_las_ppt/dat/fit2.dat");
  ...
  //A Y cut
  Double_t arange[6]={-0.25,-0.143,-0.068,0.003,0.0783,0.20};
  Double_t yrange[6]={-100,-100,-20,30,100,100};

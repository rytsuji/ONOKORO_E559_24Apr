{
  TFile *_file0 = TFile::Open("output/las/run1049.root");  
  TF1 *g1=new TF1("g1","gaus(0)",-200,200);      

  TCut xacut=Form("abs(lfp.fA+2.262523e-01/1000.*lfp.fX+0.115)<0.03");
  
  //A Y cut
  Double_t arange[6]={-0.15,-0.11,-0.07,-0.028,0.05,0.05};
  Double_t yrange[5][6]={{-60,-60,-25,30,60,60},
			 {-80,-80,-25,30,80,80},
			 {-110,-110,-25,30,105,105},
			 {-125,-125,-40,35,130,130},
			 {0,0,0,0,0,0}};			 			 			 
  ...
  //Fit
  ofstream ofile("work/ang_las_CH2/dat/delta107.dat");

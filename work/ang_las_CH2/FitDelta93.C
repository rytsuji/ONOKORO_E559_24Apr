{
  TFile *_file0 = TFile::Open("output/las/run1053.root");  
  TF1 *g1=new TF1("g1","gaus(0)",-200,200);      

  TCut xacut=Form("abs(lfp.fA+1.633309e-01/1000.*lfp.fX-0.1)<0.03");
  
  //A Y cut
  Double_t arange[6]={-0.015,-0.015,0.023,0.065,0.105,0.16};
  Double_t yrange[5][6]={{0,0,0,0,0,0},
			 {-80,-30,-8,8,35,80},
			 {-120,-60,-20,15,60,125},
			 {-100,-100,-30,30,100,100},
			 {-130,-130,-40,40,130,130}};			 			 			 
  ...
  //Fit
  ofstream ofile("work/ang_las_CH2/dat/delta93.dat");

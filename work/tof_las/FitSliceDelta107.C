//run1037 delta=107%
{
  ...
  ofstream ofile1("work/tof_las/dat/delta107.dat");
  ofstream ofile2("work/tof_las/fit/delta107_fit.dat");
  
  TFile *_file0 = TFile::Open("output/las/run1037.root");
  TH2F *hat=new TH2F("hat","LAS TOF vs a_fp(rad)",50,-0.21,0.15,100,380,480);
  TH2F *hat_slice=new TH2F("hat_slice","LAS TOF vs a_fp(rad)",1000,-0.21,0.15,1000,425,431);

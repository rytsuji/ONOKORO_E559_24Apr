...
#plot "ppt.dat" u 1:($2/0.994):($3/1.0237400) axis x1y1 with yerrorbars pt 9  lc rgb "blue" title "^{A}Ca({/Times-New-Roman:Italic p,pt})"
#replot "pph.dat" u 1:($2/2.039):($3/2.2588100) axis x1y1 with yerrorbars pt 4 lc rgb "red" title "^{A}Ca({/Times-New-Roman:Italic p,p}^{3}He)"

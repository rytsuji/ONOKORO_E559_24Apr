{
  ...
  double err_theta_las=abs(0.543*(1-pow(tan(TMath::DegToRad()*50.89),2.0))*pow(cos(TMath::DegToRad()*50.89),2.0));
  double err_phi_las=abs(0.953/sin(TMath::DegToRad()*50.89));

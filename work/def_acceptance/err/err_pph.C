{
  ...
  double err_theta_gr=abs(0.072*(1-pow(tan(TMath::DegToRad()*51.23),2.0))*pow(cos(TMath::DegToRad()*51.23),2.0));
  double err_phi_gr=abs(0.6988/sin(TMath::DegToRad()*51.23));
  double err_theta_las=abs(0.4491*(1-pow(tan(TMath::DegToRad()*50.89),2.0))*pow(cos(TMath::DegToRad()*50.89),2.0));
  double err_phi_las=abs(1.218/sin(TMath::DegToRad()*50.89));

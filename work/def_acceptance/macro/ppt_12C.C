{
  ...
  Double_t x1[7] = {+50.2,+50.2,+50.7,+51.5,+51.5,+50.7,+50.2};
  Double_t y1[7] = {-1.50,+1.50,+3.50,+3.50,-3.50,-3.50,-1.50};
  ...
  TLine *lv3 = new TLine(51.5,-5,51.5,5);
  ...
  t0.DrawLatex(51.5,-4.5,"#scale[0.7]{#theta=51.5^{#circ}}");
  ...
  c1->SaveAs("../../figs/d_thesis/acc_ppt_lab_carbon.pdf");
  c1->SaveAs("../../figs/d_thesis/acc_ppt_lab_carbon.png");  

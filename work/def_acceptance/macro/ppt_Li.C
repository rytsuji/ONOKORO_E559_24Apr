{
  ...
  TFile *_file0 = TFile::Open("root/pph_Li.root");
  TCanvas *c1 =new TCanvas("c1","",800,600);
  TH2F *h=new TH2F("h","",1000,50.5,53.0,1000,-5,5);
  ...
  c1->SaveAs("../../figs/d_thesis/acc_ppt_lab.pdf");
  c1->SaveAs("../../figs/d_thesis/acc_ppt_lab.png");  

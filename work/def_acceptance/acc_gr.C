void acc_gr(double theta0,TString fname){
  ...
  double PhiRad=0.0*TMath::DegToRad();
  ...
  for(int i=0;i<N;i++){
    a=r.Uniform(-18./1000.0,18./1000.);
    b=r.Uniform(-50./1000.,50./1000.);

    if(abs(b*1000)<(3.75*a*1000+87.5) && abs(b*1000)<(-3.75*a*1000+87.5)){

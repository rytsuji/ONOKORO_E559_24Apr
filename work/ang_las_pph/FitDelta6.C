{
  TFile *_file0 = TFile::Open("output/las/run5451127_6.root");  
  ofstream ofile("work/ang_las_pph/dat/fit6.dat");
  ...
  //A Y cut
  Double_t arange[6]={0.041,0.041,0.041,0.1045,0.165,0.25};
  Double_t yrange[6]={-80,-23,3,17,41,90};

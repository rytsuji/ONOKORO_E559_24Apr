//run1040 delta=96.5%
{
  ...
  ofstream ofile1("work/tof_las/dat/delta96.5.dat");
  ofstream ofile2("work/tof_las/fit/delta96.5_fit.dat");
  
  TFile *_file0 = TFile::Open("output/las/run1040.root");
  TH2F *hat=new TH2F("hat","LAS TOF vs a_fp(rad)",50,-0.125,0.20,100,380,480);
  TH2F *hat_slice=new TH2F("hat_slice","LAS TOF vs a_fp(rad)",1000,-0.125,0.20,1000,425,435);

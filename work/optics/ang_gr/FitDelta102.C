{
  TFile *_file0 = TFile::Open("output/gr/run1038.root");  
  ...
  double mean_a[5]={-0.01,0.01,0.03,0.05,0.07};
  ...
  double mean_y[5][5]={{0,-21,-2.5,15,0},
		       {-28.3,-15.5,-2.6,9.5,22},
		       {-22,-12,-3,7,16},
		       {-13.6,-8.5,-2.3,3.8,9.0},
		       {0,0,0,0,0}};
  ...
  for(int i=0;i<5;i++){
	...
	TString draw_b=Form("gfp.fB>>hb[%d][%d]",i,j+1);
      ...
      g3->SetParameters(300,-0.0046,0.0015,300,-0.001,0.0015,300,0.003,0.0015);
      hb4->Fit("g3","","",-0.007,0.005);
  ...
  ofstream ofile("work/ang_gr/dat/delta102.dat");

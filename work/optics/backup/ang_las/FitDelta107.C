{
  ...
  for(int i=0;i<5;i++){
    for(int j=0;j<5;j++){
      ha[i][j]=new TH1F(Form("ha[%d][%d]",i,j),Form("ha[%d][%d]",i,j),200,-0.2,0.3);
      hy[i][j]=new TH1F(Form("hy[%d][%d]",i,j),Form("hy[%d][%d]",i,j),200,-250,250);
      hb[i][j]=new TH1F(Form("hb[%d][%d]",i,j),Form("hb[%d][%d]",i,j),200,-0.3,0.2);
  ...
  //Fit
  ofstream ofile("work/ang_las/dat/delta107.dat");

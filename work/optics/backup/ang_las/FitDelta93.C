{
  TFile *_file0 = TFile::Open("output/las/run1042.root");  
  ...
  //A Y cut
  Double_t arange[6]={-0.12,-0.04,0.02,0.08,0.14,0.21};
  Double_t yrange[6]={-110,-35,0.5,12,46,120};
  ...
  //Fit
  ofstream ofile("work/ang_las/dat/delta93.dat");

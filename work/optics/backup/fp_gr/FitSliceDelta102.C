...
//run1037 delta=102%
{
  ofstream ofile1("work/fp_gr/dat/delta102.dat");
  ofstream ofile2("work/fp_gr/fit/delta102_fit.dat");
  TFile *_file0 = TFile::Open("output/gr/run1037.root");
  TH2F *hxa=new TH2F("hxa","GR VDC x(mm) vs a(rad)",120,380,440,86,-0.016,0.070);
  ...
  for(int i=0; i< xbin; i++){
    ...
    //ofile1 << "-0.019607667 " << x << " " << a << std::endl;

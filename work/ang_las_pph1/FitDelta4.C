{
  ...
  //TFile *_file0 = TFile::Open("output/las/run5451127_4.root");
  TFile *_file0 = TFile::Open("output/sieve/run5451127_4.root");  
  ofstream ofile("work/ang_las_pph1/dat/fit4.dat");
  ...
  //A Y cut
  Double_t arange[6]={-0.2,-0.0775,-0.005,0.062,0.126,0.21};
  Double_t yrange[6]={-120,-55,-6,21,72,120};

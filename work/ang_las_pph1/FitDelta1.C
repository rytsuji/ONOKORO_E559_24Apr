{
  ...
  //TFile *_file0 = TFile::Open("output/las/run5451127_1.root");
  TFile *_file0 = TFile::Open("output/sieve/run5451127_1.root");  
  TF1 *g1=new TF1("g1","gaus(0)",-250,250);    
  
  //X Fit
  double x=-400;
  
  //A Y cut
  Double_t arange[6]={-0.3,-0.185,-0.105,-0.025,0.06,0.16};
  Double_t yrange[6]={-150,-150,-30,30,150,150};
  ...
  //Fit
  ofstream ofile("work/ang_las_pph1/dat/fit1.dat");

{
  //TFile *_file0 = TFile::Open("output/las/run5451127_5.root");
  TFile *_file0 = TFile::Open("output/sieve/run5451127_5.root");  
  ofstream ofile("work/ang_las_pph1/dat/fit5.dat");
  ...
  //A Y cut
  Double_t arange[6]={-0.2,-0.047,0.017,0.082,0.1475,0.25};
  Double_t yrange[6]={-120,-38,3,16,55,120};
